...
<div class = jumbotron jumbotron-fluid>
	<div class = container>
		<h1><center>The Best Marksmen (for you)</center></h1>
		<h3><center>The champion that fits your playstyle the most is:</center></h3>
	</div>
</div>

<div class = "container">
	<div class = "row">
		<!-- Complete table of all 17 ADCs and their respective % with picture link to respective probuilds.net -->
		<div id = "fulltable" class = "col-lg-5 col-md-5 hidden-sm hidden-xs">
			<table class = "table">
				...
				<tbody>
					<?php
					include 'adc_form_functions3.php'; //reference functions already includes reference adc_array
					...
					*/
					...
					foreach($session_answer as $k => $v) {
						...
						echo "<td><a href = 'http://probuilds.net/champions/details/$k' target='_blank'>";
						echo "<IMG src='champ_pic/$k.png' width='50' height = '50'></a></td></tr>";
					};
					?>
				</tbody>
			</table>
